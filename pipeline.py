...
LUA_SHA1 = get_hash(os.path.join(CWD, 'oshietegoo.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'qa':
                ...
                wget_args.extend(['--warc-header', 'oshietegoo-profile: '+item_value])
                wget_args.append('https://oshiete.goo.ne.jp/profile/{}/'.format(item_value))
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'oshietegoo-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/4/46/Oshiete_goo_icon.png" height="50px" title=""/>
        <h2>教えて! goo <span class="links"><a href="https://oshiete.goo.ne.jp/">Website</a> &middot; <a href="http://tracker.archiveteam.org/oshietegoo/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/教えて! goo">Wiki</a></span></h2>
        <p>Archiving 教えて! goo.</p>
    '''
)
